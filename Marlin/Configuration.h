...
#define STRING_CONFIG_H_AUTHOR "Heitorado" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ado Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 273.42 }
